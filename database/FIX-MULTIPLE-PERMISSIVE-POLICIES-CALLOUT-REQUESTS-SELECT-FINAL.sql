...
-- FINAL CONSOLIDATION - Single Policy Approach
-- ============================================================================
...
--        {"Admins can view all callouts","Authenticated users can view scheduled callouts",
--         "Fighters can view own callouts"}
--
-- Solution: Consolidate ALL three policies into a SINGLE policy that handles
--           all cases using OR logic. This eliminates multiple permissive policies
--           completely while maintaining all functionality.
--
-- INSTRUCTIONS:
...
-- Drop all existing authenticated SELECT policies
...
-- Step 3: Create a SINGLE consolidated policy that handles all cases
DO $$
BEGIN
  RAISE NOTICE '';
  RAISE NOTICE '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━';
  RAISE NOTICE 'STEP 2: Creating SINGLE consolidated SELECT policy for authenticated users...';
  RAISE NOTICE '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━';
END $$;
...
-- These are separate from SELECT, so they won't cause multiple permissive policies for SELECT
DO $$
BEGIN
  RAISE NOTICE '';
  RAISE NOTICE '━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━';
...
BEGIN
  ...
  IF all_checks_pass AND auth_select_policies_count = 1 THEN
    RAISE NOTICE '';
...
-- - Before: 3 policies executed for each SELECT query → slower
