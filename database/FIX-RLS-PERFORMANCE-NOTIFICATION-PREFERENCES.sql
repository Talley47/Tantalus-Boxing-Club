-- ============================================================================
-- FIX: RLS Performance Issue on notification_preferences table
-- ============================================================================
-- Issue: RLS policy "Users can view their own notification preferences" uses
...
-- Step 1: Find all policies on notification_preferences table that need optimization
SELECT 
...
-- Users can view their own notification preferences (OPTIMIZED)
CREATE POLICY "Users can view their own notification preferences" ON public.notification_preferences
  FOR SELECT
  TO authenticated
  USING ((select auth.uid()) = notification_preferences.user_id);

-- Users can insert their own notification preferences (OPTIMIZED)
...
-- Users can update their own notification preferences (OPTIMIZED)
...
-- Users can delete their own notification preferences (OPTIMIZED)
...
BEGIN
  ...
  IF optimized_view_policy_exists 
    ...
    RAISE NOTICE '';
    RAISE NOTICE 'All RLS policies on notification_preferences table are now optimized!';
...
-- FIX COMPLETE
-- ============================================================================
-- The "Users can view their own notification preferences" policy (and related policies)
