-- ============================================================================
-- FIX: RLS Performance Issue on push_tokens table
-- ============================================================================
-- Issue: RLS policy "Users can view their own push tokens" uses
...
-- Step 1: Find all policies on push_tokens table that need optimization
SELECT 
...
-- Users can delete their own push tokens (OPTIMIZED)
...
BEGIN
  ...
  SELECT EXISTS (
    ...
    WHERE schemaname = 'public' 
      AND tablename = 'push_tokens'
      AND policyname = 'Users can view their own push tokens'
  ...
  IF optimized_view_policy_exists 
    ...
    RAISE NOTICE '';
    RAISE NOTICE 'All RLS policies on push_tokens table are now optimized!';
...
-- FIX COMPLETE
-- ============================================================================
-- The "Users can view their own push tokens" policy (and related policies)
