-- ============================================================================
-- FIX: RLS Performance Issue on rivalries table
-- ============================================================================
-- Issue: RLS policy "Users can view rivalries they are part of" uses
...
-- Step 1: Find all policies on rivalries table that need optimization
SELECT 
...
-- Users can view rivalries they are part of (OPTIMIZED)
...
-- Users can create rivalries they are part of (OPTIMIZED)
...
-- Users can update rivalries they are part of (OPTIMIZED)
...
-- Users can delete rivalries they are part of (OPTIMIZED)
...
BEGIN
  ...
  SELECT EXISTS (
    ...
    WHERE schemaname = 'public' 
      AND tablename = 'rivalries'
      AND policyname = 'Users can view rivalries they are part of'
  ...
  SELECT EXISTS (
    ...
    WHERE schemaname = 'public' 
      AND tablename = 'rivalries'
      AND policyname = 'Users can create rivalries they are part of'
  ...
  SELECT EXISTS (
    ...
    WHERE schemaname = 'public' 
      AND tablename = 'rivalries'
      AND policyname = 'Users can update rivalries they are part of'
      AND qual LIKE '%(select auth.uid())%'
  ...
  SELECT EXISTS (
    ...
    WHERE schemaname = 'public' 
      AND tablename = 'rivalries'
      AND policyname = 'Users can delete rivalries they are part of'
      AND qual LIKE '%(select auth.uid())%'
  ...
  IF optimized_view_policy_exists 
    ...
    RAISE NOTICE '';
    RAISE NOTICE 'All RLS policies on rivalries table are now optimized!';
...
-- FIX COMPLETE
-- ============================================================================
-- The "Users can view rivalries they are part of" policy (and related policies)
