-- ============================================================================
-- FIX: tournaments Duplicate SELECT Policies
-- ============================================================================
-- Consolidates duplicate SELECT policies:
-- - "Authenticated can view tournaments"
...
-- Tournaments are typically public data, so authenticated users can view all
DO $$
BEGIN
...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    RAISE NOTICE '✅ Created anon policy for tournaments';
  ELSE
