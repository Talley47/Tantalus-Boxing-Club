-- ============================================================================
-- FIX: training_camps Duplicate SELECT Policies
-- ============================================================================
-- Consolidates duplicate SELECT policies:
-- - "Authenticated can view training camps"
-- - "Authenticated users can view training camps"
...
DROP POLICY IF EXISTS "Users can view training camps" ON public.training_camps;
...
-- Training camps are typically viewable by authenticated users
DO $$
BEGIN
...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    CREATE POLICY "Public can view active training camps" 
    ON public.training_camps 
    FOR SELECT 
    TO anon 
    USING (true);
    
    RAISE NOTICE '✅ Created anon policy for training camps';
  ELSE
