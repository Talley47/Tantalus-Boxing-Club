-- Fix search_path for match_page_sections function
...
-- Fix match_page_sections() if it exists
-- This uses a simpler approach that handles all function signatures

-- Alternative approach: Fix all functions with the name match_page_sections
DO $$
DECLARE
    func_record RECORD;
BEGIN
    FOR func_record IN 
        ...
        WHERE n.nspname = 'public'
          AND p.proname = 'match_page_sections'
    LOOP
