-- Fix search_path for update_championship_belts_updated_at function
...
-- Fix update_championship_belts_updated_at() if it exists
DO $$
DECLARE
    func_record RECORD;
BEGIN
    FOR func_record IN 
        ...
        WHERE n.nspname = 'public'
          AND p.proname = 'update_championship_belts_updated_at'
    LOOP
