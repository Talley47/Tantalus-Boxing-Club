-- Fix search_path for update_fighter_tier_after_fight function
...
-- Fix update_fighter_tier_after_fight() if it exists
DO $$
DECLARE
    func_record RECORD;
BEGIN
    FOR func_record IN 
        ...
        WHERE n.nspname = 'public'
          AND p.proname = 'update_fighter_tier_after_fight'
    LOOP
