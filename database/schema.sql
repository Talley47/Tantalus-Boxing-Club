-- Tantalus Boxing Club Database Schema
...
-- We'll add additional columns as needed
...
-- Insert default admin user (this will be handled by Supabase Auth)
-- The admin account will be created through the authentication system
-- with email: admin@tantalusboxing.com and password: TantalusAdmin2025!
